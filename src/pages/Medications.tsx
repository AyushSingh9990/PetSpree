...
const Medications = () => {
  ...
  const products = selectedBreed === 'all' 
    ? getProductsByCategory('medications')
    : getProductsByBreed(selectedBreed, 'medications');

  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Pet Medications & Supplements</h1>
          <p className="text-xl text-gray-600">Health products designed for specific breed needs</p>
        </div>
