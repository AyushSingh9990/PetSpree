      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8 transform hover:scale-105 transition-all duration-300">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-2">Join PetSpree!</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-orange-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-orange-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/signin" className="text-orange-600 hover:text-orange-800 font-medium">
                Sign in here
              </Link>
            </p>
          </div>
